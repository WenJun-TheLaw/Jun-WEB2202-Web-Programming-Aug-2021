        ...
        if (isset($_POST["email"])) {
            ...
            if (isset($_POST["ssn"])) {
                ...
                if (isset($_POST["password"])) {
                    ...
                    //Adding user
                    if ($db_handle->addDeveloper($email, $password, $name, $ssn)) {
                        $log = "Account registered successfully!\\nPlease be patient while an admin reviews your application.";
                        echo "<script type='text/javascript'>
                                    alert('$log');
                                    window.location.href='index.php';
                                </script>";
...
<body>
    ...
    <div class="d-flex lex-column align-tems-center justify-content-center registration_form">
        <form method="post" action="" class="d-flex flex-column">
            ...
            <input type="ssn" class="form_inputs" name="ssn" required aria-required="true" aria-describedby="ssn">
